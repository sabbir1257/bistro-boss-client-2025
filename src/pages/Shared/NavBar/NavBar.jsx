...
const NavBar = () => {
  ...
  const navLinkClasses =
    "block px-3 py-2 text-white rounded-sm hover:text-[#BB8506] hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent";
            ...
            {navOptions.map((option) => (
              <li key={option.path}>
                <NavLink
                  ...
                  aria-current={option.path === window.location.pathname ? "page" : undefined}
                >
                  {option.label}
                </NavLink>
              </li>
